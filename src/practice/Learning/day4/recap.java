...
public class recap {
    public static void main(String[] args) {
        ...
        long waterInOcean = 200_000_000_000_000L; // compiler takes 2000000000 int type, but this number is too big for int, so doesn't compile, we need to add L to make it a long type.
